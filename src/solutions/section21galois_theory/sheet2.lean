...
begin
  by_cases h : finite_dimensional E F,
  { resetI, apply finrank_mul_finrank, },
  { rw [finrank_of_infinite_dimensional h, zero_mul, finrank_of_infinite_dimensional],
    refine mt _ _,
    swap,
    introI h,
    apply finite_dimensional.left E F K,
    exact h, },
end
